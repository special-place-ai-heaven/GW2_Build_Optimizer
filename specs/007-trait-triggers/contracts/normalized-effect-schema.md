...
`class` ∈ `PassiveNoEffect`, `NeedsMechanic`. `mechanic` is required for `NeedsMechanic` and names the game mechanism the simulator lacks, as the audit table lists it; the Necromancer increment uses `spirits`, `carapace threshold`, `carapace stat scaling`, `protection condition reduction`, `blight`, `shades`, `life siphon`, `barrier`, `ally state`, `recharge`, `trait skill`, `weapon-scoped duration`, `downed`, `minions`, `incoming damage reduction`, `life force scaling`, `dodge`, `revive`, `disable trigger`, `condition damage heal`, `crit chance per stack`, `fear damage`, `kill`, `percent heal`, `elixir`, `incoming condition duration`, `damage-scaled heal`, `marks`, `incoming healing`, `life force threshold`; the Ranger increment adds `pet`, `pet swap`, `weapon swap`, `traps`, `endurance`, `opening strike`, `interrupt`, `celestial avatar`, `wind force`, `squall`, `movement skill`, `arrows`, `skill replace`, `transform`, `unleash`, `protection state`, `boon extension`, `incoming condition`, `stance duration`; the Thief increment adds `steal`, `stealth`, `shadowstep`, `initiative`, `artifact`, `malice`, `deadeye mark`, `shadow shroud`, `siphon`, `unique condition count`, `flanking`, `stolen skill`; the Warrior increment adds `adrenaline`, `burst`, `berserk`, `banners`, `soldiers focus`, `block`, `fire aura`, `dragon trigger`, `ammunition`, `explosion`, `chants`, `refrain`, `commands`, `motivation`, `full counter`, `condition duration`; the Guardian increment adds `virtues`, `aegis`, `consecrations`, `symbols`, `signets`, `tomes`, `pages`, `mantras`, `ashes`, `radiant forge`, `light aura`, `physical`, `vitality scaling`, `incoming strike`, `boon grant`, `weapon-scoped`; the Engineer increment adds `toolbelt`, `kits`, `gadgets`, `turrets`, `gyros`, `heat`, `photon forge`, `mech`, `morph`, `evolve`; the Elementalist increment adds `attunement`, `aura`, `overload`, `dual attack`, `jade sphere`, `elemental empowerment`, `familiar`, `conjure`, `glyphs`, `cantrips`, `meditations`, `combo`; the Mesmer increment adds `clones`, `phantasms`, `shatter`, `mirage cloak`, `continuum split`, `distortion`, `deceptions`, `ambush`, `blades`, `bladesong`, `instruments`, `notes`, `alacrity`; the Revenant increment adds `legend`, `energy`, `upkeep`, `stance`, `facets`, `consume`, `citadel`, `kalla's fervor`, `band together`, `cosmic wisdom`, `affinity`, `energy meld`, `alliance`, `battle scars`, `combat`, `profession skill`, `max health`; later increments add theirs (`bundle`). A name is retired when the mechanism lands (Sprint 3 convergence retired `carapace`). A record with `coverage` MUST NOT carry `status_operation`, `inner_category`, `prerequisite` or a resolved `value`.
